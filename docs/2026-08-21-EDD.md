...
- Colors: not needed yet — when Dock/Overlay styling starts, use this palette (extracted from
  the One Big Function design system's Figma variables) rather than inventing ad hoc colors:
